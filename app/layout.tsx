...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en">
      ...
      <meta property="og:description" content="Find and book barbers effortlessly with FadeFlow. Schedule haircuts, explore grooming services, and stay fresh." />
      <meta name="keywords" content="barber, barbershop, haircut, booking app, barbers appointment, barberia, barbero, fade, men's grooming, FadeFlow, barber booking app" />
      <meta property="og:image" content="/images/banner.png" />
      <meta property="og:url" content="https://fadeflow.vercel.app"></meta>
      </head>
